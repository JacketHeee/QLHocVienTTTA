...
public class CaNhan {
    ...
    public CaNhan() {}
    public CaNhan(String cccd, String hoten, NgayThangNam ngaysinh, DiaChi noisinh, int gioitinh) {
        this.cccd = cccd;
        this.hoten = hoten;
    ...
    public void setInfor() {
        ...
        noisinh.setInfor();
        this.cccd = Generate.IDPerson(this.noisinh.getTinh().getMatinh(), this.gioitinh, this.ngaysinh.getNam()); 
    }
    ...
    public String getInfor() {
        return cccd+ ";" +hoten+ ";" +ngaysinh.getInfor()+ ";" +gioitinh+ ";" + noisinh.getInfor(); 
    }
    ...
    public void show() {
        System.out.printf(" %12s | %-15s%6s | %10s | %-3d | %s\n",cccd,getAllBeforeName(),getName(),ngaysinh.getInfor(),gioitinh,noisinh.getInfor());
    }
